...
public class ExerciseData {
    ...
    public static HashMap<String, List<String>> getInfo()
    {
        ...
        Pushups.add("Pushups Description: A conditioning exercise performed in a prone position by raising" +
        ...
        Squats.add("Squats Description: The basic squat is an extremely effective lower body move that " +
        ...
        Crunches.add("Crunches Description: A crunch begins with lying face up on the floor with knees bent. " +
        ...
        High_Knees.add("High Knees Description: High knees combine the typical running motion with exaggerated knee lifts. " +
        ...
        Tricep_Dips.add("Trciep Dips Description: Straighten your arms, keeping a little bend in your elbows to " +
        ...
        Jump_Squat.add("Jump Squat Description: Stand with your feet shoulder-width apart " +
        ...
        Wall_Sit.add("Wall Sit Description: A wall sit is an exercise done to strengthen the quadriceps muscles. " +
